  ...
  useEffect(() => {
    async function loadScripts() {
      try {
        ...
        console.error('Tech Load Error:', e);
      } finally {
        setIsLoading(false);
      }
    }
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div className="flex items-center gap-2 text-red-500 mb-2">
            <Cpu size={20} />
            <span className="text-xs font-bold uppercase tracking-widest">Tech Channel</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight">Tech Scripts</h1>
          <p className="text-zinc-500 mt-2">Review, approve, or reject tech scripts.</p>
        </div>
